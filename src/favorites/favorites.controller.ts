...
export class FavoritesController {
  ...
  addArtist(@Param('id', ParseUUIDPipe) id: string): { message: string } {
  ...
  @Post('album/:id')
  @HttpCode(HttpStatus.CREATED)
  addAlbum(@Param('id', ParseUUIDPipe) id: string): { message: string } {
  ...
  @Post('track/:id')
  @HttpCode(HttpStatus.CREATED)
  addTrack(@Param('id', ParseUUIDPipe) id: string): { message: string } {
